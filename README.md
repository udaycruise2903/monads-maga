...
The generated HTML site can be previewed here: https://udaycruise2903.github.io/monads-maga/
...
- As a first step to using this template,
  - change the project name in .cabal, flake.nix and hie.yaml files; then commit changes to Git.
    - To automate this, `mv monads-maga.cabal myproject.cabal; nix run nixpkgs#sd -- monads-maga myproject * */* .github/*/*`
- Configuration:
